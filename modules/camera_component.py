...
def camera_widget(trigger_token: str, key: str) -> str | None:
    """Rendert die Live-Kameravorschau. Gibt das aufgenommene Foto als
    Base64-JPEG zurück, sobald trigger_token sich geändert hat und die
    Aufnahme erfolgt ist - sonst None."""
    return _component_func(trigger_token=trigger_token, key=key, default=None)
